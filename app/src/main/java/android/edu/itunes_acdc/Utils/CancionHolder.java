package android.edu.itunes_acdc.Utils;

import android.content.Context;
import android.content.Intent;
import android.edu.itunes_acdc.DetalleCancion;
import android.edu.itunes_acdc.Inicio;
import android.edu.itunes_acdc.R;
...
public class CancionHolder extends android.support.v7.widget.RecyclerView.ViewHolder
{
    ...
    CancionHolder(final View itemView, final Context contexto) {
        ...
        imageFavorito.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (favorita)
                {
                    ...
                    baseDatosCanciones= Inicio.getBaseDatosCanciones();
        ...
        imagenMedia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mp=Inicio.getReproductor();
                imagenPlaying=Inicio.getPlayButton();
                play=playingThis;
    ...
    private void reproducirCancion (View v)
    {
        ...
        try {
            ...
            Inicio.setPlayButton((ImageView) v);
    ...
    {   //TODO ACTUALIZAR TODOS LOS CAMPOS
        ...
        try
        {
            this.favorita=Inicio.getBaseDatosCanciones().buscarCancion(cancionObj.getTrackId());
        }
        catch (Exception e)
        {
            this.favorita=false;
    ...
    {   //Toast.makeText(contexto,"Ir DETALLE",Toast.LENGTH_SHORT).show();
        ...
        pararCancion(Inicio.getPlayButton());
