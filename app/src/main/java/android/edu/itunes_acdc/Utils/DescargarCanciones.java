...
public class DescargarCanciones extends AsyncTask<String, Void, ResultadoCanciones> {
    ...
    private static final String URI_ITUNES="https://itunes.apple.com/search/?media=music&limit=";
    ...
    public DescargarCanciones (Inicio mA) { this.inicio=mA; }
    ...
    protected ResultadoCanciones doInBackground(String... canciones) {
        ...
        try
        {   url=new URL(URI_ITUNES+canciones[0]+"&term="+canciones[1]);
    ...
    protected void onPostExecute(ResultadoCanciones resultadoCanciones) {
        ...
        inicio.mostrarResultados(resultadoCanciones);
